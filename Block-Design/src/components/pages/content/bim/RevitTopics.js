...
import { BarChart, CameraVideo, Command, FileEarmarkBinary, InputCursorText, Map, Megaphone, Person, Play, PersonVideo, BookFill, BookHalf, BookmarkCheck} from 'react-bootstrap-icons';
    ...
    return (
        <Container>
            ...
            <Row xs={1} className="mb-3">
                <Col xs={3}>
                    <Card border="dark" style={{ width: '16rem' }} >
                        <Card.Header>Starting A New Project</Card.Header>
                        <Card.Body style={{
                            display: 'flex',
            ...
            <Row xs={1} className="mb-3">
                <Col xs={3}>
                    <Card border="dark" style={{ width: '16rem' }}>
                        <Card.Header>Design Session</Card.Header>
                        <Card.Body style={{
                            display: 'flex',
                            justifyContent: 'center',
                            alignItems: 'center',
                            ...
                            <Link to="/docs/initiatives/collection-and-looks">
                                <br />
                                <PersonVideo size={40} color='black' />
                                <br />
                                <br />
                            </Link>
                        </Card.Body>
                ...
                <Col xs={3}>
                    <Card border="dark" style={{ width: '16rem' }}>
                        <Card.Header>Build Manual</Card.Header>
                        <Card.Body style={{
                            display: 'flex',
                            justifyContent: 'center',
                            alignItems: 'center',
            ...
            <Row xs={1} className="mb-3">
                <Col xs={3}>
                    <Card border="dark" style={{ width: '16rem' }}>
                        <Card.Header>Revit General Practices</Card.Header>
                        <Card.Body style={{
                            display: 'flex',
                            justifyContent: 'center',
                            alignItems: 'center',
                            ...
                            <Link to="/docs/initiatives/collection-and-looks">
                                <br />
                                <BookmarkCheck size={40} color='black' />
                                <br />
                                <br />
                            </Link>
                        </Card.Body>
